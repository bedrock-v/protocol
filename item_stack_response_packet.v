...
fn read_item_stack_response_entry(mut r Reader) !ItemStackResponseEntry {
...
fn write_item_stack_response_entry(mut w Writer, e ItemStackResponseEntry) {
	w.u8(e.status)
...
pub fn (mut p ItemStackResponsePacket) decode_payload(mut r Reader) ! {
...
pub fn (p &ItemStackResponsePacket) encode_payload(mut w Writer) {

...
pub fn (mut p ServerboundDataDrivenScreenClosedPacket) decode_payload(mut r Reader) ! {
	p.form_id = int(r.le_u32()!)
	p.close_reason = r.read_string()!
}

pub fn (p &ServerboundDataDrivenScreenClosedPacket) encode_payload(mut w Writer) {

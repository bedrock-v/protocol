...
pub fn (mut p ResourcePacksReadyForValidationPacket) decode_payload(mut r Reader) ! {
}

pub fn (p &ResourcePacksReadyForValidationPacket) encode_payload(mut w Writer) {
}

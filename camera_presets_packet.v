...
pub mut:
	...
	horizontal_rotation_limit     Vector2
	has_vertical_rotation_limit   bool
	vertical_rotation_limit       Vector2
...
fn read_camera_preset_aim_assist(mut r Reader) !CameraPresetAimAssist {
...
fn write_camera_preset_aim_assist(mut w Writer, a CameraPresetAimAssist) {
	if a.has_preset {
		w.bool(true)
...
fn read_camera_preset(mut r Reader) !CameraPreset {
	mut c := CameraPreset{
		name:   r.read_string()!
...
fn write_camera_preset(mut w Writer, c CameraPreset) {
...
pub fn (mut p CameraPresetsPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &CameraPresetsPacket) encode_payload(mut w Writer) {

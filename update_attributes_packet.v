...
pub fn (mut p UpdateAttributesPacket) decode_payload(mut r Reader) ! {
	p.actor_runtime_id = r.read_actor_runtime_id()!
	count := int(r.read_varuint32()!)
	p.entries = []UpdateAttribute{cap: count}
	for _ in 0 .. count {
...
pub fn (p &UpdateAttributesPacket) encode_payload(mut w Writer) {

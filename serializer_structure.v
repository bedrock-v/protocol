...
pub fn (mut r Reader) read_structure_settings() !StructureSettings {
...
pub fn (mut w Writer) write_structure_settings(s StructureSettings) {
...
pub fn (mut r Reader) read_structure_editor_data() !StructureEditorData {
	mut d := StructureEditorData{
...
pub fn (mut w Writer) write_structure_editor_data(d StructureEditorData) {

...
pub fn (mut p GraphicsOverrideParameterPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &GraphicsOverrideParameterPacket) encode_payload(mut w Writer) {

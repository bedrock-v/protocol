...
pub fn (mut p PlayerToggleCrafterSlotRequestPacket) decode_payload(mut r Reader) ! {
	p.position = BlockPosition{
		x: int(r.le_i32()!)
		y: int(r.le_i32()!)
		z: int(r.le_i32()!)
	}
...
pub fn (p &PlayerToggleCrafterSlotRequestPacket) encode_payload(mut w Writer) {

	...
	match d {
		0 {
			return PlayerLocationCoordinates{
				unknown:  r.read_varint32()!
				position: [r.le_f32()!, r.le_f32()!, r.le_f32()!]!
			}
		}
		1 { return PlayerLocationHide{ unknown: r.read_varint32()! } }
		else { return error('invalid PlayerLocationType ${d}') }
	}
}

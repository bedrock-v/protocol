...
pub type GameRuleLegacyType = GameRuleBool | GameRuleFloat | GameRuleInt
...
pub fn GameRuleLegacyType.decode(mut r serializer.Reader) !GameRuleLegacyType {
	d := r.read_varuint32()!
	match d {
		1 { return GameRuleBool{ value: r.bool()! } }
		2 { return GameRuleInt{ value: r.le_i32()! } }
		3 { return GameRuleFloat{ value: r.le_f32()! } }
...
pub mut:
	...
	rule_type                 GameRuleLegacyType = GameRuleBool{}
}
...
pub fn GameRuleLegacyData.decode(mut r serializer.Reader) !GameRuleLegacyData {
	...
	mut items := []GameRuleLegacyChanged{cap: count}
	for _ in 0 .. count {
		items << GameRuleLegacyChanged.decode(mut r)!
	}
...
pub mut:
	...
	game_type                                    enums_662.GameType
	is_hardcore_enabled                          bool
	game_difficulty                              enums_662.Difficulty
	default_spawn_block_position                 types_944.NetworkBlockPosition
	achievements_disabled                        bool
	editor_world_type                            enums_662.EditorWorldType
	...
	xbox_live_broadcast_setting                  enums_662.GamePublishSetting
	platform_broadcast_setting                   enums_662.GamePublishSetting
	...
	chat_restriction_level                       enums_662.ChatRestrictionLevel
...
pub fn (t LevelSettings) encode(mut w serializer.Writer) {
	...
	w.write_varint32(t.server_editor_connection_policy)
	w.bool(t.allow_anonymous_block_drops_in_editor_worlds)
}
...
pub fn LevelSettings.decode(mut r serializer.Reader) !LevelSettings {
	...
	t.generator_type = enums_662.GeneratorType.decode(mut r)!
	t.game_type = enums_662.GameType.decode(mut r)!
	t.is_hardcore_enabled = r.bool()!
	t.game_difficulty = enums_662.Difficulty.decode(mut r)!
	t.default_spawn_block_position = types_944.NetworkBlockPosition.decode(mut r)!
	t.achievements_disabled = r.bool()!
	t.editor_world_type = enums_662.EditorWorldType.decode(mut r)!
	...
	t.xbox_live_broadcast_setting = enums_662.GamePublishSetting.decode(mut r)!
	t.platform_broadcast_setting = enums_662.GamePublishSetting.decode(mut r)!
	...
	t.chat_restriction_level = enums_662.ChatRestrictionLevel.decode(mut r)!
	t.disable_player_interactions = r.bool()!
	t.server_editor_connection_policy = r.read_varint32()!
	t.allow_anonymous_block_drops_in_editor_worlds = r.bool()!
	return t
}

...
import serializer
import nbt
import version.v465.types as types_465
...
pub mut:
	...
	nether_type                         bool
	edu_shared_uri_resource             types_465.EduSharedUriResource
...
pub fn (mut p StartGamePacket) decode_payload(mut r serializer.Reader) ! {
	...
	p.edu_shared_uri_resource = types_465.EduSharedUriResource.decode(mut r)!

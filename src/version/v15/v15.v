...
import protocol
import protocol.version.v15.packets
...
pub fn new_pool() protocol.PacketPool {
	...
	pool.register(|| protocol.Packet(&packets_14.ReadyPacket{}))
	pool.register(|| protocol.Packet(&packets_14.MessagePacket{}))
	pool.register(|| protocol.Packet(&packets_14.SetTimePacket{}))
	pool.register(|| protocol.Packet(&packets_14.StartGamePacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.MoveEntityPosRotPacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.LevelEventPacket{}))
	pool.register(|| protocol.Packet(&packets_14.TileEventPacket{}))
	pool.register(|| protocol.Packet(&packets_14.EntityEventPacket{}))
	pool.register(|| protocol.Packet(&packets_14.RequestChunkPacket{}))
	pool.register(|| protocol.Packet(&packets_14.ChunkDataPacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.UseItemPacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.SetEntityMotionPacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.ContainerOpenPacket{}))
	...
	pool.register(|| protocol.Packet(&packets_14.EntityDataPacket{}))
	return pool
}

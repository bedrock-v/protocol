...
pub fn (p &ClientBoundControlSchemeSetPacket) pid() u16 { return 327 }

pub fn (p &ClientBoundControlSchemeSetPacket) name() string { return 'ClientBoundControlSchemeSetPacket' }

pub fn (p &ClientBoundControlSchemeSetPacket) can_be_sent_before_login() bool { return false }

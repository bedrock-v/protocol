...
pub enum MemoryCategoryCounterType as u8 {
	...
	persona_skin_packs                         = 59
	persona_repo                               = 60
	player                                     = 61
	render_chunk                               = 62
	render_chunk_index_buffer                  = 63
	render_chunk_vertex_buffer                 = 64
	rendering                                  = 65
	rendering_bgfx_init                        = 66
	rendering_bgfx_start_frame                 = 67
	rendering_bgfx_tessellator                 = 68
	rendering_bgfx_end_frame                   = 69
	rendering_bgfx_graphics_tasks_init         = 70
	rendering_library                          = 71
	rendering_polygon_operator_pool            = 72
	rendering_pbr_texture_data                 = 73
	rendering_render_registry                  = 74
	rendering_setup                            = 75
	rendering_vertices                         = 76
	request_log                                = 77
	resource_packs                             = 78
	sound                                      = 79
	sub_chunk_biome_data                       = 80
	sub_chunk_block_data                       = 81
	sub_chunk_light_data                       = 82
	textures                                   = 83
	weather_renderer                           = 84
	world_generator                            = 85
	tasks                                      = 86
	test                                       = 87
	test_load_test_flags                       = 88
	scripting                                  = 89
	...
	data_driven_ui                             = 95
	data_driven_ui_defs                        = 96
	gameface                                   = 97
	gameface_system                            = 98
	gameface_dom                               = 99
	gameface_css                               = 100
	gameface_display                           = 101
	gameface_temp_allocator                    = 102
	gameface_pool_allocator                    = 103
	gameface_dump                              = 104
	gameface_media                             = 105
	gameface_json                              = 106
	gameface_script_engine                     = 107
	gameface_script                            = 108
	gameface_layout                            = 109
}
...
pub fn (e EntityDiagnosticTimingInfo) encode(mut w serializer.Writer) {
	...
	w.le_f32(e.position[0])
	w.le_f32(e.position[1])
	w.le_f32(e.position[2])
	w.write_string(e.dimension)
}

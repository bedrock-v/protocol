...
pub fn (e HandSlot) encode(mut w serializer.Writer) {
	w.u8(u8(e))
}

pub fn HandSlot.decode(mut r serializer.Reader) !HandSlot {
	return unsafe { HandSlot(r.u8()!) }
}
...
pub mut:
	...
	action           types_2168.InventoryTransaction
...
pub fn PackedItemUseLegacyInventoryTransaction.decode(mut r serializer.Reader) !PackedItemUseLegacyInventoryTransaction {
	...
	t.action = types_2168.InventoryTransaction.decode(mut r)!

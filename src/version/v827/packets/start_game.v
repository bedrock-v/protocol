...
pub mut:
	...
	position                              [3]f32
	rotation                              [2]f32
	settings                              types_818.LevelSettings
	level_id                              string
	level_name                            string
	...
	tick_death_systems_enabled            bool
...
pub fn (p &StartGamePacket) encode_payload(mut w serializer.Writer) {
	...
	w.bool(p.tick_death_systems_enabled)
...
pub fn (mut p StartGamePacket) decode_payload(mut r serializer.Reader) ! {
	...
	p.settings = types_818.LevelSettings.decode(mut r)!
	...
	p.block_properties = block_properties
	...
	p.tick_death_systems_enabled = r.bool()!

...
pub fn (p &JigsawStructureDataPacket) pid() u16 { return 313 }

pub fn (p &JigsawStructureDataPacket) name() string { return 'JigsawStructureDataPacket' }

pub fn (p &JigsawStructureDataPacket) can_be_sent_before_login() bool { return false }

...
import version.v685.types as types_685
...
pub mut:
	...
	recipe_tag            string
	priority              i32
	unlocking_requirement types_685.RecipeUnlockingRequirement
	network_id            u32
}
...
pub fn ShulkerBoxRecipe.decode(mut r serializer.Reader) !ShulkerBoxRecipe {
	...
	t.ingredient_list = []types_662.RecipeIngredient{cap: ing_count}
	...
	t.unlocking_requirement = types_685.RecipeUnlockingRequirement.decode(mut r)!

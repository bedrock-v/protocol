...
pub fn (p &SimulationTypePacket) pid() u16 { return 168 }

pub fn (p &SimulationTypePacket) name() string { return 'SimulationTypePacket' }

pub fn (p &SimulationTypePacket) can_be_sent_before_login() bool { return false }

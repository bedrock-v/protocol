...
pub fn (p &ServerPlayerPostMovePositionPacket) pid() u16 { return 16 }

pub fn (p &ServerPlayerPostMovePositionPacket) name() string { return 'ServerPlayerPostMovePositionPacket' }

pub fn (p &ServerPlayerPostMovePositionPacket) can_be_sent_before_login() bool { return false }

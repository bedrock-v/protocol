...
pub fn (p &MapCreateLockedCopyPacket) pid() u16 { return 131 }

pub fn (p &MapCreateLockedCopyPacket) name() string { return 'MapCreateLockedCopyPacket' }

pub fn (p &MapCreateLockedCopyPacket) can_be_sent_before_login() bool { return false }

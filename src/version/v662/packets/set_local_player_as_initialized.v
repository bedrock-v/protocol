...
pub fn (p &SetLocalPlayerAsInitializedPacket) pid() u16 { return 113 }

pub fn (p &SetLocalPlayerAsInitializedPacket) name() string { return 'SetLocalPlayerAsInitializedPacket' }

pub fn (p &SetLocalPlayerAsInitializedPacket) can_be_sent_before_login() bool { return false }

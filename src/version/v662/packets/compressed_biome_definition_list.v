...
pub fn (p &CompressedBiomeDefinitionListPacket) pid() u16 { return 301 }

pub fn (p &CompressedBiomeDefinitionListPacket) name() string { return 'CompressedBiomeDefinitionListPacket' }

pub fn (p &CompressedBiomeDefinitionListPacket) can_be_sent_before_login() bool { return false }

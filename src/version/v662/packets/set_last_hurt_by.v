...
pub fn (p &SetLastHurtByPacket) pid() u16 { return 96 }

pub fn (p &SetLastHurtByPacket) name() string { return 'SetLastHurtByPacket' }

pub fn (p &SetLastHurtByPacket) can_be_sent_before_login() bool { return false }

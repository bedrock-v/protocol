...
pub fn (p &PassengerJumpPacket) pid() u16 {
	return 20
}

pub fn (p &PassengerJumpPacket) name() string {
	return 'PassengerJumpPacket'
}

pub fn (p &PassengerJumpPacket) can_be_sent_before_login() bool {
	return false
}

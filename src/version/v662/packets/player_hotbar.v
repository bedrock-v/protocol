...
pub fn (p &PlayerHotbarPacket) pid() u16 { return 48 }

pub fn (p &PlayerHotbarPacket) name() string { return 'PlayerHotbarPacket' }

pub fn (p &PlayerHotbarPacket) can_be_sent_before_login() bool { return false }

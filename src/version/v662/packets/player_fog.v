...
pub fn (p &PlayerFogPacket) pid() u16 { return 160 }

pub fn (p &PlayerFogPacket) name() string { return 'PlayerFogPacket' }

pub fn (p &PlayerFogPacket) can_be_sent_before_login() bool { return false }

...
pub fn (p &SyncActorPropertyPacket) pid() u16 { return 165 }

pub fn (p &SyncActorPropertyPacket) name() string { return 'SyncActorPropertyPacket' }

pub fn (p &SyncActorPropertyPacket) can_be_sent_before_login() bool { return false }

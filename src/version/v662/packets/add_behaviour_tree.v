...
pub fn (p &AddBehaviourTreePacket) pid() u16 { return 89 }

pub fn (p &AddBehaviourTreePacket) name() string { return 'AddBehaviourTreePacket' }

pub fn (p &AddBehaviourTreePacket) can_be_sent_before_login() bool { return false }

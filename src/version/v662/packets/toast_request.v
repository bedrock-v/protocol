...
pub fn (p &ToastRequestPacket) pid() u16 { return 186 }

pub fn (p &ToastRequestPacket) name() string { return 'ToastRequestPacket' }

pub fn (p &ToastRequestPacket) can_be_sent_before_login() bool { return false }

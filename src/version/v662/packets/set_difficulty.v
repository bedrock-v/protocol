...
pub fn (p &SetDifficultyPacket) pid() u16 { return 60 }

pub fn (p &SetDifficultyPacket) name() string { return 'SetDifficultyPacket' }

pub fn (p &SetDifficultyPacket) can_be_sent_before_login() bool { return false }

...
pub fn (p &SetHealthPacket) pid() u16 { return 42 }

pub fn (p &SetHealthPacket) name() string { return 'SetHealthPacket' }

pub fn (p &SetHealthPacket) can_be_sent_before_login() bool { return false }

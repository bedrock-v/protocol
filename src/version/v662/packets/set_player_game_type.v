...
pub fn (p &SetPlayerGameTypePacket) pid() u16 { return 62 }

pub fn (p &SetPlayerGameTypePacket) name() string { return 'SetPlayerGameTypePacket' }

pub fn (p &SetPlayerGameTypePacket) can_be_sent_before_login() bool { return false }

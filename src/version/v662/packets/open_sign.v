...
pub fn (p &OpenSignPacket) pid() u16 { return 303 }

pub fn (p &OpenSignPacket) name() string { return 'OpenSignPacket' }

pub fn (p &OpenSignPacket) can_be_sent_before_login() bool { return false }

...
pub fn (p &SetTimePacket) pid() u16 { return 10 }

pub fn (p &SetTimePacket) name() string { return 'SetTimePacket' }

pub fn (p &SetTimePacket) can_be_sent_before_login() bool { return false }

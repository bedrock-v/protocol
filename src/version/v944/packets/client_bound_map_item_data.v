...
pub mut:
	...
	decoration_list []types_662.MapDecoration
}

pub struct MapTypeCreation {
pub mut:
	map_id_list []types_662.ActorUniqueID
}
...
pub fn ClientBoundMapType.decode_payload(id u32, mut r serializer.Reader) !ClientBoundMapType {
	match id {
		...
		0x4 {
			...
			t.decoration_list = []types_662.MapDecoration{cap: dc}
			for _ in 0 .. dc {
				t.decoration_list << types_662.MapDecoration.decode(mut r)!
			}
			return t
		}
		0x8 {
			...
			t.map_id_list = []types_662.ActorUniqueID{cap: mc}
			for _ in 0 .. mc {
				t.map_id_list << types_662.ActorUniqueID.decode(mut r)!
			}
			return t
		}
		else {

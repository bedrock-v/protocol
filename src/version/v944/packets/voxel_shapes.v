...
pub fn (p &VoxelShapesPacket) pid() u16 { return 337 }

pub fn (p &VoxelShapesPacket) name() string { return 'VoxelShapesPacket' }

pub fn (p &VoxelShapesPacket) can_be_sent_before_login() bool { return false }

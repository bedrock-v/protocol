...
pub mut:
	...
	position   [3]f32
	data       i32
	actor_type enums_662.ActorType
	baby_mob   bool
	global     bool
}

pub fn (p &LevelSoundEventV1Packet) pid() u16 { return 24 }

pub fn (p &LevelSoundEventV1Packet) name() string { return 'LevelSoundEventV1Packet' }

pub fn (p &LevelSoundEventV1Packet) can_be_sent_before_login() bool { return false }
...
pub fn (mut p LevelSoundEventV1Packet) decode_payload(mut r serializer.Reader) ! {
	...
	p.actor_type = enums_662.ActorType.decode(mut r)!
	p.baby_mob = r.bool()!
	p.global = r.bool()!
}

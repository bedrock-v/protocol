...
pub mut:
	...
	structure_block_position BlockPosition
...
pub fn (mut p StructureTemplateDataRequestPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &StructureTemplateDataRequestPacket) encode_payload(mut w Writer) {

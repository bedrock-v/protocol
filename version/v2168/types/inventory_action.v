...
pub mut:
	...
	slot                 u32
	from_item_descriptor NetworkItemStackDescriptorV2
	to_item_descriptor   NetworkItemStackDescriptorV2
}
...
pub fn InventoryAction.decode(mut r serializer.Reader) !InventoryAction {
	return InventoryAction{
		...
		from_item_descriptor: NetworkItemStackDescriptorV2.decode(mut r)!
		to_item_descriptor:   NetworkItemStackDescriptorV2.decode(mut r)!
	}
}

...
pub fn (p &TickingAreaLoadStatusPacket) pid() u16 {
	return 179
}

pub fn (p &TickingAreaLoadStatusPacket) name() string {
	return 'TickingAreaLoadStatusPacket'
}

pub fn (p &TickingAreaLoadStatusPacket) can_be_sent_before_login() bool {
	return false
}

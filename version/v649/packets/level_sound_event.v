...
import protocol.version.v567.enums as enums_567

pub struct LevelSoundEventPacket {
pub mut:
	sound                    enums_567.SoundEvent
...
pub fn (mut p LevelSoundEventPacket) decode_payload(mut r serializer.Reader) ! {
	p.sound = unsafe { enums_567.SoundEvent(r.read_varuint32()!) }

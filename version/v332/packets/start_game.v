...
pub mut:
	...
	block_palette                     []packets_291.BlockPaletteEntry
...
pub fn (mut p StartGamePacket) decode_payload(mut r serializer.Reader) ! {
	...
	mut palette := []packets_291.BlockPaletteEntry{cap: serializer.prealloc(palette_count)}
	for _ in 0 .. palette_count {
		palette << packets_291.BlockPaletteEntry{
			name: r.read_string()!
			meta: r.le_i16()!
		}
	}

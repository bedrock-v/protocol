...
fn read_server_join_information(mut r Reader) !ServerJoinInformation {
...
fn write_server_join_information(mut w Writer, s ServerJoinInformation) {
...
pub fn (mut p StartGamePacket) decode_payload(mut r Reader) ! {
...
pub fn (p &StartGamePacket) encode_payload(mut w Writer) {

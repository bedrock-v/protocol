...
fn read_data_store_update(mut r Reader) !DataStoreUpdate {
...
fn write_data_store_update(mut w Writer, u DataStoreUpdate) {
...
pub fn (mut p ServerboundDataStorePacket) decode_payload(mut r Reader) ! {
	p.update = read_data_store_update(mut r)!
}

pub fn (p &ServerboundDataStorePacket) encode_payload(mut w Writer) {

...
fn read_enchant_list(mut r Reader) ![]Enchant {
...
fn write_enchant_list(mut w Writer, list []Enchant) {
...
pub fn (mut p PlayerEnchantOptionsPacket) decode_payload(mut r Reader) ! {
	count := r.read_varuint32()!
...
pub fn (p &PlayerEnchantOptionsPacket) encode_payload(mut w Writer) {

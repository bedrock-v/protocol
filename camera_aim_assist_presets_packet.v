...
fn read_string_list(mut r Reader) ![]string {
...
fn write_string_list(mut w Writer, list []string) {
...
fn read_aim_assist_priority_list(mut r Reader) ![]CameraAimAssistPriority {
	count := r.read_varuint32()!
...
fn write_aim_assist_priority_list(mut w Writer, list []CameraAimAssistPriority) {
	w.write_varuint32(u32(list.len))
	for e in list {
...
fn read_aim_assist_priorities(mut r Reader) !CameraAimAssistPriorities {
...
fn write_aim_assist_priorities(mut w Writer, pr CameraAimAssistPriorities) {
...
fn read_aim_assist_preset(mut r Reader) !CameraAimAssistPreset {
...
fn write_aim_assist_preset(mut w Writer, pre CameraAimAssistPreset) {
...
pub fn (mut p CameraAimAssistPresetsPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &CameraAimAssistPresetsPacket) encode_payload(mut w Writer) {

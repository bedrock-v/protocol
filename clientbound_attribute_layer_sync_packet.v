...
fn read_attribute_data(mut r Reader) !AttributeData {
	mut a := AttributeData{
...
fn write_attribute_data(mut w Writer, a AttributeData) {
...
fn read_attribute_layer_settings(mut r Reader) !AttributeLayerSettings {
...
fn write_attribute_layer_settings(mut w Writer, s AttributeLayerSettings) {
	w.le_i32(s.priority)
...
fn read_environment_attribute(mut r Reader) !EnvironmentAttributeData {
...
fn write_environment_attribute(mut w Writer, e EnvironmentAttributeData) {
...
fn read_attribute_layer(mut r Reader) !AttributeLayerData {
...
fn write_attribute_layer(mut w Writer, l AttributeLayerData) {
...
pub fn (mut p ClientboundAttributeLayerSyncPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &ClientboundAttributeLayerSyncPacket) encode_payload(mut w Writer) {

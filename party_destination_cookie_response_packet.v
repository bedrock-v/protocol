...
pub fn (mut p PartyDestinationCookieResponsePacket) decode_payload(mut r Reader) ! {
	p.cookie = r.read_string()!
	p.accepted = r.bool()!
}

pub fn (p &PartyDestinationCookieResponsePacket) encode_payload(mut w Writer) {

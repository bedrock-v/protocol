...
fn read_command_string_list(mut r Reader) ![]string {
...
fn write_command_string_list(mut w Writer, list []string) {
...
pub fn (mut p AvailableCommandsPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &AvailableCommandsPacket) encode_payload(mut w Writer) {

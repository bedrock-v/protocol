...
pub mut:
	...
	block_face            u8
	hotbar_slot           int
	held_item             ItemStackWrapper
	position              Vector3
	clicked_position      Vector3
...
fn read_inventory_action(mut r Reader) !InventoryAction {
...
fn write_inventory_action(mut w Writer, a InventoryAction) {
...
fn read_use_item_transaction_data(mut r Reader) !UseItemTransactionData {
...
fn write_use_item_transaction_data(mut w Writer, d UseItemTransactionData) {
...
pub fn (mut p InventoryTransactionPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &InventoryTransactionPacket) encode_payload(mut w Writer) {

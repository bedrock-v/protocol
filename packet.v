...
pub interface Packet {
	...
	encode_payload(mut w Writer)
mut:
	decode_payload(mut r Reader) !
}

pub fn write_packet_header(mut w Writer, pid u16, sender_sub_id u8, recipient_sub_id u8) {
...
pub fn read_packet_header(mut r Reader) !DecodedHeader {
...
pub fn encode_packet(p Packet, mut w Writer) {

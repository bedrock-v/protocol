...
fn read_subchunk_entry(mut r Reader, cache_enabled bool) !SubChunkEntry {
	mut e := SubChunkEntry{
		offset: SubChunkPositionOffset{
			x_offset: r.i8()!
			y_offset: r.i8()!
...
fn write_subchunk_entry(mut w Writer, e SubChunkEntry, cache_enabled bool) {
...
pub fn (mut p SubChunkPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &SubChunkPacket) encode_payload(mut w Writer) {

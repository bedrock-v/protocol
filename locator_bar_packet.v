...
fn read_locator_waypoint(mut r Reader) !LocatorBarWaypoint {
...
fn write_locator_waypoint(mut w Writer, wp LocatorBarWaypoint) {
...
pub fn (mut p LocatorBarPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &LocatorBarPacket) encode_payload(mut w Writer) {

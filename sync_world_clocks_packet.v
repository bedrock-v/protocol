...
fn read_time_marker(mut r Reader) !TimeMarkerData {
...
fn write_time_marker(mut w Writer, m TimeMarkerData) {
...
pub fn (mut p SyncWorldClocksPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &SyncWorldClocksPacket) encode_payload(mut w Writer) {

...
fn read_camera_spline_instruction(mut r Reader) !CameraSplineInstruction {
...
fn write_camera_spline_instruction(mut w Writer, ins CameraSplineInstruction) {
...
pub fn (mut p CameraSplinePacket) decode_payload(mut r Reader) ! {
...
pub fn (p &CameraSplinePacket) encode_payload(mut w Writer) {

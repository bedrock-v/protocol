...
fn read_data_store_property_value(mut r Reader) !DataStorePropertyValue {
...
fn write_data_store_property_value(mut w Writer, v DataStorePropertyValue) {
	w.le_i32(v.type_id)
	match v.type_id {
		data_store_property_none {}
...
pub fn (mut p ClientboundDataStorePacket) decode_payload(mut r Reader) ! {
	count := r.read_varuint32()!
...
pub fn (p &ClientboundDataStorePacket) encode_payload(mut w Writer) {

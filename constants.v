...
pub const ability_build = int(enums.AbilitiesIndex.build)
pub const ability_mine = int(enums.AbilitiesIndex.mine)
pub const ability_doors_and_switches = int(enums.AbilitiesIndex.doors_and_switches)
pub const ability_open_containers = int(enums.AbilitiesIndex.open_containers)
pub const ability_attack_players = int(enums.AbilitiesIndex.attack_players)
pub const ability_attack_mobs = int(enums.AbilitiesIndex.attack_mobs)
pub const ability_may_fly = int(enums.AbilitiesIndex.may_fly)
pub const ability_instabuild = int(enums.AbilitiesIndex.instabuild)
pub const ability_walk_speed = int(enums.AbilitiesIndex.walk_speed)
pub const ability_count = int(20)

...
pub fn (t CameraColor) encode(mut w serializer.Writer) {
	w.le_f32(t.r)
	w.le_f32(t.g)
	w.le_f32(t.b)
}

pub fn CameraColor.decode(mut r serializer.Reader) !CameraColor {
	return CameraColor{
		r: r.le_f32()!
		g: r.le_f32()!
		b: r.le_f32()!
...
pub fn FadeInstruction.decode(mut r serializer.Reader) !FadeInstruction {
	...
	if r.bool()! {
		t.color = CameraColor.decode(mut r)!
	}
	return t
}
...
pub fn TargetInstruction.decode(mut r serializer.Reader) !TargetInstruction {
	...
	t.actor_unique_id = ActorUniqueID.decode(mut r)!
	return t
}
...
pub fn CameraInstruction.decode(mut r serializer.Reader) !CameraInstruction {
	...
	if r.bool()! {
		t.spline = CameraSplineInstruction.decode(mut r)!
	}
	if r.bool()! {

...
pub fn LevelSettings.decode(mut r serializer.Reader) !LevelSettings {
	mut t := LevelSettings{}
	t.seed = r.le_u64()!
	t.spawn_settings = SpawnSettings.decode(mut r)!
	...
	t.experiments = Experiments.decode(mut r)!
	...
	t.base_game_version = BaseGameVersion.decode(mut r)!
	t.limited_world_width = r.le_i32()!
	t.limited_world_depth = r.le_i32()!
	t.nether_type = r.bool()!
	t.edu_shared_uri_resource = EduSharedUriResource.decode(mut r)!
	if r.bool()! {

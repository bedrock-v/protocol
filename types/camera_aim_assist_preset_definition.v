...
pub mut:
	...
	entity_type_families_exclusion_list []string
...
pub fn (t CameraAimAssistPresetDefinition) encode(mut w serializer.Writer) {
	...
	write_string_list(mut w, t.entity_type_families_exclusion_list)
...
pub fn CameraAimAssistPresetDefinition.decode(mut r serializer.Reader) !CameraAimAssistPresetDefinition {
	...
	count := r.read_count()!
	t.item_settings = []CameraAimAssistItemSettings{cap: serializer.prealloc(count)}
	for _ in 0 .. count {

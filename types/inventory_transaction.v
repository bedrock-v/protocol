...
// LegacyUseItemTransactionData is sent when a player interacts with a block: place,
// use (right click in air) or destroy (break).
pub struct LegacyUseItemTransactionData {
pub mut:
...
pub fn (t LegacyUseItemTransactionData) encode(mut w serializer.Writer) {
...
pub fn LegacyUseItemTransactionData.decode(mut r serializer.Reader) !LegacyUseItemTransactionData {
	return LegacyUseItemTransactionData{
		action_type:      enums.ItemUseInventoryTransactionType.decode(mut r)!
		trigger_type:     TriggerType.decode(mut r)!
		position:         NetworkBlockPosition.decode(mut r)!
		face:             i32(r.u8()!)
...
pub mut:
	...
	action_type       enums.ItemUseOnActorInventoryTransactionType
	slot              i32
	item              NetworkItemStackDescriptor
	from_position     [3]f32
	click_position    [3]f32
...
pub fn UseItemOnEntityTransactionData.decode(mut r serializer.Reader) !UseItemOnEntityTransactionData {
	return UseItemOnEntityTransactionData{
		...
		action_type:       enums.ItemUseOnActorInventoryTransactionType.decode(mut r)!
		slot:              r.read_varint32()!
		item:              NetworkItemStackDescriptor.decode(mut r)!
		from_position:     [r.le_f32()!, r.le_f32()!, r.le_f32()!]!
		click_position:    [r.le_f32()!, r.le_f32()!, r.le_f32()!]!
...
pub mut:
	action_type   enums.ItemReleaseInventoryTransactionType
	slot          i32
	item          NetworkItemStackDescriptor
	head_position [3]f32
}
...
pub fn ReleaseItemTransactionData.decode(mut r serializer.Reader) !ReleaseItemTransactionData {
	return ReleaseItemTransactionData{
		action_type:   enums.ItemReleaseInventoryTransactionType.decode(mut r)!
		slot:          r.read_varint32()!
		item:          NetworkItemStackDescriptor.decode(mut r)!

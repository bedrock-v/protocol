...
pub fn (mut p AddActorPacket) decode_payload(mut r Reader) ! {
	...
	p.attributes = []ActorAttribute{cap: attr_count}
	for _ in 0 .. attr_count {
		p.attributes << ActorAttribute{
			id:      r.read_string()!
			min:     r.le_f32()!
			current: r.le_f32()!
			max:     r.le_f32()!
	...
	p.links = []EntityLink{cap: link_count}
	for _ in 0 .. link_count {
		p.links << r.read_entity_link()!
	}
}

pub fn (p &AddActorPacket) encode_payload(mut w Writer) {

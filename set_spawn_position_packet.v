...
pub mut:
	...
	dimension              int
	causing_block_position BlockPosition
}
...
pub fn (mut p SetSpawnPositionPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &SetSpawnPositionPacket) encode_payload(mut w Writer) {

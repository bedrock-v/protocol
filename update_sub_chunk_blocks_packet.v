...
pub mut:
	base_block_position BlockPosition
...
fn read_sub_chunk_block_entries(mut r Reader) ![]UpdateSubChunkBlocksEntry {
...
fn write_sub_chunk_block_entries(mut w Writer, entries []UpdateSubChunkBlocksEntry) {
...
pub fn (mut p UpdateSubChunkBlocksPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &UpdateSubChunkBlocksPacket) encode_payload(mut w Writer) {

...
pub mut:
	...
	cyl_radius_x    Vector2
	cyl_radius_z    Vector2
	cyl_height      f32
	cyl_segments    u8
...
fn read_packet_shape_data(mut r Reader) !PacketShapeData {
...
fn write_packet_shape_data(mut w Writer, s PacketShapeData) {
...
pub fn (mut p PrimitiveShapesPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &PrimitiveShapesPacket) encode_payload(mut w Writer) {

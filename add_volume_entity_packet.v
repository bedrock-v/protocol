...
pub mut:
	...
	min_bound       BlockPosition
	max_bound       BlockPosition
	dimension       int
...
pub fn (mut p AddVolumeEntityPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &AddVolumeEntityPacket) encode_payload(mut w Writer) {

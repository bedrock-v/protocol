...
fn read_f32_list(mut r Reader) ![]f32 {
...
fn write_f32_list(mut w Writer, list []f32) {
...
fn read_voxel_shape(mut r Reader) !VoxelShape {
	mut s := VoxelShape{}
	s.cells.x_size = r.u8()!
	s.cells.y_size = r.u8()!
	s.cells.z_size = r.u8()!
...
fn write_voxel_shape(mut w Writer, s VoxelShape) {
	w.u8(s.cells.x_size)
	w.u8(s.cells.y_size)
	w.u8(s.cells.z_size)
...
pub fn (mut p VoxelShapesPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &VoxelShapesPacket) encode_payload(mut w Writer) {

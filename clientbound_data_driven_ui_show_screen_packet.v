...
pub fn (mut p ClientboundDataDrivenUIShowScreenPacket) decode_payload(mut r Reader) ! {
...
pub fn (p &ClientboundDataDrivenUIShowScreenPacket) encode_payload(mut w Writer) {
